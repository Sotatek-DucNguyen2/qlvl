          ...
          <div class="x_content">
            ...
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="admin/job/edit/{{ $job->id }}" method="POST">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" required="required" name ="id_company" class="form-control col-md-7 col-xs-12" value="{{$job-> Company -> name_company}}" readonly="">
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Yêu cầu thời gian công việc <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select name="type_job" id="" class="form-control col-md-7 col-xs-12">
                    <option value="{{$job->type_job}}">{{$job->type_job}}</option>
              ...
              <div class="form-group">
                <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Loại công việc</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                   <select name="description_job" id="" class="form-control col-md-7 col-xs-12">
                      <option value="{{$job->description_job}}">{{$job->description_job}}</option>
